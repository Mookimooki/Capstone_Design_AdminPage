...
<head>
    ...
    <link rel="stylesheet" href="css/lib/html5-editor/bootstrap-wysiphp5.css" />
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Bootstrap wysiphp5</h4>
                                <h6 class="card-subtitle">Bootstrap php5 editor</h6>
                                <form method="post">
                                    <div class="form-group">
    ...
    <script src="js/lib/html5-editor/wysiphp5-0.3.0.js"></script>
    <script src="js/lib/html5-editor/bootstrap-wysiphp5.js"></script>
    <script src="js/lib/html5-editor/wysiphp5-init.js"></script>
    <!--Custom JavaScript -->
